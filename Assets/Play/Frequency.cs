...
public class Frequency : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        range = Setting_GM.range_setting;
    ...
    void Update()
    {
        if(Setting_GM.swipe_mode == false)
        {
            FreqValue = GS.gyro_value_x;
        }
        else if(Setting_GM.swipe_mode == true)
        {
            FreqValue = TS.SwipeToFreq;
        }
        ...
        if (auto_pich == false)
        {
            ...
            freq = FreqValue * freq_range + Min_freq / 2;
        ...
        if (auto_pich == true)
        {
            ...
            freq_number = FreqValue * freq_number_range + Min_freq_number;
